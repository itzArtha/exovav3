          ...
          >
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <Link
                  to={"/"}
                  className="block py-2 pr-4 pl-3 rounded md:bg-transparent md:text-blue-700 md:p-0 md:font-semibold"
                >
                  Beranda
                </Link>
              </li>
              <li>
                <Link
                  to={"/"}
                  className="block py-2 pr-4 pl-3 font-semibold text-black border-b md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0"
                >
